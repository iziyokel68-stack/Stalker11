/**
 * S.T.A.L.K.E.R. — тест условной компиляции, профиль ESP32-WROOM32
 *
 * Проверяет ветку #ifdef как в Terminal_ESP32 / Cashier_ESP32:
 *   TERMINAL_BOARD_WROOM32 → I2C GPIO 21/22
 *
 * Открывайте: test_firmware/CondCompile_WROOM32/CondCompile_WROOM32.ino
 *
 * Arduino IDE:
 ...
 *   OK:READY
 *
 * Сравните с CondCompile_ESP32C3 — profile и пины должны отличаться.
