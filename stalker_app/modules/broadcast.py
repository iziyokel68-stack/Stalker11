...
Доставка: программа мастера (stalker_app) → USB LORA_TX → ПДА или поле с Ra-01 → эфир по ID игрока (0 = все).
    ...
    def _build(self):
        ...
        ttk.Label(
            ...
            text="Адрес LoRa — только ID игрока события.\n"
                 ...
                 "CHIP_BOX ответит NO_LORA: подключите ПДА или поле с Ra-01.",
    ...
    def _send_lora(self):
        ...
        if cmd_ok:
            ...
            messagebox.showwarning(
                ...
                "Сохранено в журнале.\n"
                f"{resp}\n"
                "Полевая доставка — USB к ПДА или полю с Ra-01 "
                "(программа мастера = пульт).",
                parent=self,
            )
